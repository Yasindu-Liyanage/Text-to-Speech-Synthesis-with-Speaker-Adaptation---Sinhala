...
def main():
    # Define Paths
    dataset_name = "sin_2241"
    output_path = os.path.join("E:/UOM/FYP/TTSx/Training/Sinhala", dataset_name)
    dataset_path = os.path.join("E:/UOM/FYP/TTSx/Data/OpeSLR/Speakers/", dataset_name)
    meta_file_train = os.path.join(dataset_path, "metadata.csv")
    checkpoint_dir = os.path.join(output_path, "vits_sinhala_lady-January-10-2025_11+42AM-0000000")  # Directory for checkpoints
    ...
    # Find Checkpoint
    latest_checkpoint = "E:/UOM/FYP/TTSx/Training/Sinhala/sin_2241/vits_sinhala_lady-January-10-2025_11+42AM-0000000"
